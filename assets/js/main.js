            ...
            selectedServices.forEach(function(service) {
                switch (service.toLowerCase()) {
                    case 'logo design':
                        ...
                        message += 'Please email your brand name, a short description of your business, and any design ideas or preferences to mthokozisih.hlatshwayo@gmail.com.\n\n';
                        break;

                    case 'web design':
                        message += 'Web Design (R1000 – R3500):\n';
                        message += 'To begin, send your design style, color preferences, number of pages, and example websites to mthokozisih.hlatshwayo@gmail.com.\n\n';
                        break;

                    case 'web development':
                        message += 'Web Development (R3500 – R9000):\n';
                        message += 'Please email the features or functionality you need to mthokozisih.hlatshwayo@gmail.com.\n\n';
                        break;

                    case 'cv revamp':
                        message += 'CV Revamp:\n';
                        message += 'Email your current CV to mthokozisih.hlatshwayo@gmail.com and choose a package:\n';
                        message += '- R100: PDF + Canva link\n';
                        message += '- R200: PDF + Word + Canva link\n';
                        message += '- R250: PDF + Word + Canva link + Picture\n\n';
                        break;

                    case 'video editing':
                        message += 'Video Editing (R350 – R1200):\n';
                        message += 'Send your raw footage and a short description of what you’d like to achieve to mthokozisih.hlatshwayo@gmail.com.\n\n';
                        break;

                    case 'other':
                        message += 'Custom Request:\n';
                        message += 'Please share the details of the service you need.\n\n';
                        break;

                    default:
                        message += service + ':\n';
                        message += 'We’ll follow up shortly with more information.\n\n';
                        break;
